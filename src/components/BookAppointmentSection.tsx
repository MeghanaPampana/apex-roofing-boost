...
const BookAppointmentSection = () => {
  return (
    <section id="book-appointment" className="min-h-[80vh] relative overflow-hidden">
      ...
      ></div>
      <div className="max-w-6xl mx-auto px-4 relative z-10 flex items-center justify-center min-h-[80vh]">
        {/* <div className="max-w-6xl mx-auto mb-20"> */}
          <Card className="glass-card transition-all duration-500 w-full max-w-8xl min-h-[500px] flex items-end justify-center" style={{ border: "2px solid white" }}>
